defmodule ROS.SlaveApi.Behaviour do
  ...
  @callback shutdown(caller_id(), message :: String.t()) ::
              {integer(), String.t(), integer()}
  @callback get_pid(caller_id()) :: {integer(), String.t(), integer()}
  @callback get_subscriptions(caller_id()) ::
              {integer(), String.t(), [[String.t()]]}
  @callback get_publications(caller_id()) ::
              {integer(), String.t(), [[String.t()]]}
  ...
  @callback publisher_update(
              caller_id(),
              topic :: String.t(),
              publishers :: [String.t()]
            ) :: {integer(), String.t(), integer()}
  @callback request_topic(
              caller_id(),
              topic :: String.t(),
              protocol :: [[String.t()]]
